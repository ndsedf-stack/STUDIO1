...
function useWorkoutHistory() {
  ...
  const addEntry = reactExports.useCallback((dateStr, entry) => {
    setHistory((prev) => {
  ...
  const removeEntry = reactExports.useCallback((dateStr) => {
    setHistory((prev) => {
      const next = { ...prev };
      delete next[dateStr];
      try {
...
function ExerciseItem({ ex }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: ex.name ?? prettyId(ex.id) }),
    " — ",
    ex.sets ?? "-",
    " sets × ",
    ex.reps ?? "-",
...
function Superset({ ex }) {
  ...
  if (!ex) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "superset", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "superset-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Superset" }),
        " — ",
        ex.name ?? prettyId(ex.id),
        " ",
        ex.rest ? ` (rest ${ex.rest}s)` : ""
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "toggle-btn", onClick: () => setOpen((o) => !o), children: open ? "Hide" : "Show" }) })
    ] }),
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { margin: 0, paddingLeft: 16 }, children: ex.exercises && ex.exercises.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(ExerciseItem, { ex: s }, s.id)) })
  ] });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "app-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brand", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "currentColor", style: { color: "#2563eb" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 8.5C21 7.12 19.88 6 18.5 6H17V5C17 4.45 16.55 4 16 4H8C7.45 4 7 4.45 7 5V6H5.5C4.12 6 3 7.12 3 8.5V15.5C3 16.88 4.12 18 5.5 18H7V19C7 19.55 7.45 20 8 20H16C16.55 20 17 19.55 17 19V18H18.5C19.88 18 21 16.88 21 15.5V8.5Z" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Workouts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "meta", style: { fontSize: 13 }, children: [
          days.length,
          " days"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cards", children: [
        days.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 700 }, children: "No workouts configured" }),
        ...
        days.map((dayKey) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "start", gap: 12 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: w2.name ?? prettyId(dayKey) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "meta", children: Array.isArray(w2.exercises) ? `${w2.exercises.length} exercises` : "No exercises" })
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "app-footer", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 6 }, children: "Deployed from repository — prototype view." })
    ] })
  ] });
}
